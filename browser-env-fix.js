module.exports = () => {
        ...
        for (j = 0; j < 4; j++) {
          if (binary.indexOf(flag[j].str, start) == start) {
            if (flag[j].len == 8) {
              ...
              newStr =
                newStr + String.fromCharCode(parsetInt(binary.substr(start + 3, 5) + binary.substr(start + 10, 6), 2));
            } else if (flag[j].len == 16) {
              newStr =
                newStr +
                String.fromCharCode(
                  parsetInt(
                    binary.substr(start + 4, 4) + binary.substr(start + 10, 6) + binary.substr(start + 18, 6),
                    2
                  )
                );
              ...
              newStr =
                ...
                String.fromCharCode(
                  parseInt(
                    binary.substr(start + 5, 3) +
                      binary.substr(start + 10, 6) +
                      binary.substr(start + 18, 6) +
                      binary.substr(start + 26, 6),
                    2
                  )
                );
            }
  ...
  document.referrer = 'https://www.skland.com/';
  ...
  navigator.appVersion =
    '5.0 (Macintosh; Intel Mac OS X 10_14_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36';
  ...
  var location = new URL('https://www.skland.com/');
